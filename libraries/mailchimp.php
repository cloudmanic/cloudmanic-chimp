...
// Date: 12/9/2010
//
// Description: Changed very little from the example code given out 
//								from Mailchimp to fall into Codeigniter (php framework)
//
...
class MailChimp
{
    ...
    var $secure = false;
		...
		*/
		function __construct()
		{
		  ...
		  if($this->_CI->config->item('mcapikey'))
		  {
		  	$this->initialize($this->_CI->config->item('mcapikey'), 
		  										$this->_CI->config->item('mcapisecure'));
		  }
		
		  log_message('debug', "Mail Chimp Api Class Initialized");
		}
     ...
     */
    function initialize($apikey, $secure = false) 
    {
        $this->secure = $secure;
...
/* End of file MailChimpApi.php */
/* Location: ./application/libraries/mailchimpapi.php */